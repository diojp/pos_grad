...
export default class ProductController {
    ...
    static async update(req, res) {
        try {
            ...
            const product = await ProductService.update(req, idProduto, name, description, state, purchased_at);
    ...
    static async schedule(req, res) {
        try {
            ...
            const msg = await ProductService.schedule(req, id);
    ...
    static async concludeDonation(req, res) {
        try {
            ...
            const msg = await ProductService.concludeDonation(req, id);
